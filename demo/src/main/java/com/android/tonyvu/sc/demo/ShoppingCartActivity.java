...
public class ShoppingCartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvCartItems.setLongClickable(true);
        lvCartItems.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                alert.setTitle(getResources().getString(R.string.delete_item));
                alert.setMessage(getResources().getString(R.string.delete_item_message));
